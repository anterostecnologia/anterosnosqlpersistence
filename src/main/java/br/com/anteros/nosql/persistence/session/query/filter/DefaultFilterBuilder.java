...
import br.com.anteros.nosql.persistence.session.query.parameter.NamedParameter;
...
public class DefaultFilterBuilder extends BaseVisitor {
	...
	public String toNoSql(NoSQLDialect dialect, Filter filter) throws FilterException {
		filter.runVisitors();
		filter.accept(this);
	...
	public String toSortNoSql(NoSQLDialect dialect, Filter filter) throws FilterException {
		String result = "";
