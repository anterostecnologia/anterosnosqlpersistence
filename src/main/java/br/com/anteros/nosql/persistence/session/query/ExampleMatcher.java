...
public interface ExampleMatcher {
	...
	class GenericPropertyMatcher {
		...
		public int hashCode() {
			...
			result = prime * result + ((stringMatcher == null) ? 0 : stringMatcher.hashCode());
			result = prime * result + ((valueTransformer == null) ? 0 : valueTransformer.hashCode());
			return result;
		}
		...
		public boolean equals(Object obj) {
			...
			if (ignoreCase == null) {
				...
				return false;
			if (stringMatcher != other.stringMatcher)
				return false;
			if (valueTransformer == null) {
				if (other.valueTransformer != null)
					return false;
			} else if (!valueTransformer.equals(other.valueTransformer))
				return false;
			return true;
		}
	}
	...
	class PropertySpecifier {
		...
		public PropertySpecifier(String path, StringMatcher stringMatcher, Boolean ignoreCase,
				PropertyValueTransformer valueTransformer) {
			super();
			this.path = path;
			this.stringMatcher = stringMatcher;
