...
public abstract class AbstractBeforeConvertEvent<T> extends NoSQLEvent<T> {

	public AbstractBeforeConvertEvent(Object source, T document, String collectionName) {
